...
export default function App() {
  ...
  const handleULDSelect = (uld, boxDims) => {
    setSelectedULD([uld.dimensions_cm.length/100, uld.dimensions_cm.width/100, uld.dimensions_cm.height/100]);
    setBoxSize(boxDims);
  };
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col">
      ...
      <main className="flex-1 p-6 space-y-8">
        <h1 className="text-4xl font-bold mb-4">ULD Matcher with Real Airline Dataset</h1>
